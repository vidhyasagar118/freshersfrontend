...
<div className="steps">
   <h1 className="stepsheading">Steps to Vote:</h1>
          ...
          <li  className="step">Click <b>Go To Vote</b> Button</li>
          <li  className="step">Vote Button will be enabled only when Timer is Live</li>
          <li className="step">Gallery Page → Old Year Photos</li>
          <li  className="step">Program Details → About Event & Organizers</li>
        </ol>
</div>
